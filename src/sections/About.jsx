...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('nrdnandan@gmail.com');
        setHasCopied(true);
        setTimeout(() => {
            setHasCopied(false);
        }, 2000)
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                With 2 years of experience I have worked on multiple projects in 3D animated websites.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            ...
                            className="grid-subtext"
                            >
                                I specialize in JavaScript/TypeScript with a focus on React frameworks and Next.js ecosystems.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            ...
                            className="grid-headtext"
                            >
                                I work remotely across most of the time zones.
                            </p>
                            <p
                            className="grid-subtext"
                            >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                />
                                <p
                                className="lg:text-2xl md:text-xl font-medium text-gray_gradeitn text-white"
                                >
                                    nrdnandan@gmail.com
                                </p>
                            </div>
